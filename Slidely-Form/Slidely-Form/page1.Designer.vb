...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        ' btnViewSubmission
        ' 
        btnViewSubmission.BackColor = Color.Yellow
        ...
        ' 
        btnCreateNewSubmission.BackColor = Color.FromArgb(CByte(192), CByte(192), CByte(255))
        ...
        lblTitle.TabIndex = 2
        lblTitle.Text = "Aritra Pal, Slidely Task 2 - Slidely Form App"
        ' 
        ' Form1
        ' 
