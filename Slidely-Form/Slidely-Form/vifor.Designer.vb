...
Partial Class vifor
    ...
    Private Sub InitializeComponent()
        ...
        lblViewFormTitle.Location = New Point(85, 29)
        lblViewFormTitle.Name = "lblViewFormTitle"
        lblViewFormTitle.Size = New Size(294, 20)
        lblViewFormTitle.TabIndex = 13
        lblViewFormTitle.Text = "Aritra Pal, Slidely Task 2 - View Submissions"
        ' 
        ' btnNext
        ' 
        btnNext.BackColor = Color.FromArgb(CByte(192), CByte(192), CByte(255))
        ...
        lblStopWatch.Size = New Size(79, 40)
        lblStopWatch.TabIndex = 22
        lblStopWatch.Text = "Stopwatch" & vbCrLf & "    time"
        ' 
        ' btnDelete
        ' 
