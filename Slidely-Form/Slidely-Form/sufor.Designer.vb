...
Partial Class sufor
    ...
    Private Sub InitializeComponent()
        ...
        lblCreateFormTitle.Location = New Point(63, 21)
        lblCreateFormTitle.Name = "lblCreateFormTitle"
        lblCreateFormTitle.Size = New Size(299, 20)
        lblCreateFormTitle.TabIndex = 0
        lblCreateFormTitle.Text = "Aritra Pal, Slidely Task 2 - Create Submission"
        ' 
        ' txtName
        ' 
        ...
        ' btnStopWatchToggle
        ' 
        btnStopWatchToggle.BackColor = Color.Yellow
        btnStopWatchToggle.Location = New Point(12, 306)
        btnStopWatchToggle.Name = "btnStopWatchToggle"
        btnStopWatchToggle.Size = New Size(237, 32)
        btnStopWatchToggle.TabIndex = 10
        btnStopWatchToggle.Text = "TOGGLE STOPWATCH (CTRL + T)"
        btnStopWatchToggle.UseVisualStyleBackColor = False
        ' 
        ' btnSubmit
        ' 
        btnSubmit.BackColor = Color.FromArgb(CByte(192), CByte(192), CByte(255))
